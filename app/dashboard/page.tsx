        ...
        {(challenges ?? []).length > 0 && (
          <div style={{ marginBottom: 20 }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }}>
              ...
              <Link href="/challenges" style={{ fontSize: 12, color: "var(--color-accent)", textDecoration: "none" }}>View all</Link>
            </div>
        ...
        {(recentNotes ?? []).length > 0 && (
          <div>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }}>
              ...
              <Link href="/notes" style={{ fontSize: 12, color: "var(--color-accent)", textDecoration: "none" }}>All notes</Link>
            </div>
